...
cd target/swig/c
/Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/arm-apple-darwin9-gcc-4.0.1 -gfull -ObjC -c CoreGraphics.c -c OpenGLES.c -c OpenAL.c -c SystemConfiguration.c -isysroot $SDK -I /sw/include
