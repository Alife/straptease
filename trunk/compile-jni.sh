...
#compile:
/Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/arm-apple-darwin9-gcc-4.0.1 -c CoreGraphics.c -c OpenGLES.c -c OpenAL.c -c SystemConfiguration.c -isysroot $SDK -I /sw/include
